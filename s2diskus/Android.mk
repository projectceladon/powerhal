...
LOCAL_SRC_FILES := image_saver.c lib.c canframelen.c cansend.c candump.c watchdogd.c
LOCAL_MODULE := image_saver
...
LOCAL_SRC_FILES := resume.c memalloc.c config_parser.c loglevel.c load.c
LOCAL_STATIC_LIBRARIES := \
        liblzo \
	liblz4_static \
	libisal_igzip \
